...
public static class OpenInFileBrowser
{
    ...
    [MenuItem("Project/PlayerPrefabClear", false, 3)]
    public static void clearPlayerPrefab()
    {
        PlayerPrefs.DeleteAll();
    }

	[MenuItem("Project/Open Browser/temporaryCachePath",false, 5)]
	public static void temporaryCachePath()
	{
		Open(UnityEngine.Application.temporaryCachePath);
	}
    [MenuItem("Project/Open Browser/dataPath",false,5)]
	public static void dataPath()
	{
		Open(UnityEngine.Application.dataPath);
	}
    [MenuItem("Project/Open Browser/persistentDataPath",false, 5)]
	...
	private static void OpenInWin(string path)
	{
		...
		try
		{
			System.Diagnostics.Process.Start("explorer.exe", (openInsidesOfFolder ? "/select," : "/root,") + winPath);
		}
		catch ( System.ComponentModel.Win32Exception e )
		{
